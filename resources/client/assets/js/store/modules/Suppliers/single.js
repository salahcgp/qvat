...
const actions = {
    storeData({ commit, state, dispatch }) {
        ...
        return new Promise((resolve, reject) => {
            ...
            axios.post('/api/v1/suppliers', params)
                .then(response => {
                    commit('resetState')
                    resolve()
                })
    ...
    updateData({ commit, state, dispatch }) {
        ...
        return new Promise((resolve, reject) => {
            ...
            axios.post('/api/v1/suppliers/' + state.item.id, params)
                .then(response => {
    ...
    setSupplier_name({ commit }, value) {
        commit('setSupplier_name', value)
    },
...
const mutations = {
    ...
    setSupplier_name(state, value) {
        state.item.supplier_name = value
    },
