...
export default {
    data() {
        return {
            ...
            xprops: {
                module: 'CreateCompaniesIndex',
                route: 'create_companies',
                permission_prefix: 'create_company_'
            }
        }
    },
    created() {
    ...
    computed: {
        ...mapGetters('CreateCompaniesIndex', ['data', 'total', 'loading', 'relationships']),
    },
    watch: {
        query: {
            handler(query) {
    ...
    methods: {
        ...mapActions('CreateCompaniesIndex', ['fetchData', 'setQuery', 'resetState']),
    }
}
</script>
