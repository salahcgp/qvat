...
export default {
    ...
    computed: {
        ...mapGetters('CreateCompaniesSingle', ['item', 'loading']),
    },
    created() {
    ...
    methods: {
        ...mapActions('CreateCompaniesSingle', ['fetchData', 'updateData', 'resetState', 'setCompany_name', 'setBilling_address', 'setShipping_address', 'setMobile', 'setPhone', 'setEmail', 'setTrn']),
        ...
        submitForm() {
            this.updateData()
                .then(() => {
                    this.$router.push({ name: 'create_companies.index' })
