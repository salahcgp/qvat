...
export default {
    ...
    computed: {
        ...mapGetters('PurchaseInvoicesSingle', ['item', 'loading', 'createcompaniesAll', 'suppliersAll']),
    },
    created() {
    ...
    methods: {
        ...mapActions('PurchaseInvoicesSingle', ['fetchData', 'updateData', 'resetState', 'setCompany', 'setInvoice_no', 'setInvoice_date', 'setCustomer', 'setQuantity', 'setPrice', 'setVat', 'setDiscount', 'setAmount_before_vat', 'setTransaction_total']),
        updateCompany(value) {
        ...
        submitForm() {
            this.updateData()
                .then(() => {
                    this.$router.push({ name: 'purchase_invoices.index' })
