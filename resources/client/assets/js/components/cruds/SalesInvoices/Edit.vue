...
export default {
    ...
    methods: {
        ...mapActions('SalesInvoicesSingle', ['fetchData', 'updateData', 'resetState', 'setCompany', 'setInvoice_no', 'setInvoice_date', 'setCustomer', 'setQuantity', 'setPrice', 'setVat', 'setDiscount', 'setAmount_before_vat', 'setTransaction_total']),
        updateCompany(value) {
