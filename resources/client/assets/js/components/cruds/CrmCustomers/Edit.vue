...
export default {
    ...
    methods: {
        ...mapActions('CrmCustomersSingle', ['fetchData', 'updateData', 'resetState', 'setFirst_name', 'setLast_name', 'setCrm_status', 'setEmail', 'setPhone', 'setAddress', 'setSkype', 'setWebsite', 'setDescription']),
        updateFirst_name(e) {
