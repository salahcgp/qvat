...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>Sales Invoices- {{ $company_name }}</title>
        <!-- Bootstrap CSS -->
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="container">
                    ...
                    <div class="col-md-12 col-md-offset-2">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form method="GET" action="/search_inv">
                            ...
                            <button class="btn btn-success" name="Save" type="submit" value="search_inv">Save</button>
                ...
                <div class="row">
                    <div class="col-md-12 col-md-offset-2">
                        <div class="panel panel-default">
                            <div class="panel-heading">Sales Invoices- {{ $company_name }}</div>
                            <div class="panel-body">
