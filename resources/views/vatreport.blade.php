...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>VAT Return - {{ $company_name }}</title>
        <!-- Bootstrap CSS -->
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="container">
                    ...
                    <div class="col-md-12 col-md-offset-2">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form method="GET" action="/search_vat">
                            ...
                            <button class="btn btn-success" name="Save" type="submit" value="search_vat">Save</button>
                ...
                <div class="row">
                    <div class="col-md-12 col-md-offset-2">
                        <div class="panel panel-default">
                            <div class="panel-heading">VAT Return - {{ $company_name }}</div>
                            <div class="panel-body">
                                <table class="table table-sm" id="datatable">
                                    <thead>
                                        <tr>
                                            <th>Company Name</th>
                                            <th>Description </th>
                                            <th class="text-right">Amount before VAT</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($union_data as $sd)
                                        <tr>
                                            
                                            <td>{{ $sd->company_name }}</td>
                                            <td>{{ $sd->title }}</td>
