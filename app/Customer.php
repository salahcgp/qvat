...
class Customer extends Model
{
    ...
    protected $fillable = ['customer_name', 'billing_address', 'shipping_address', 'mobile', 'phone', 'email', 'trn', 'created_by_id', 'created_by_team_id'];
    

    public static function storeValidation($request)
    {
        return [
            'customer_name' => 'max:191|required',
